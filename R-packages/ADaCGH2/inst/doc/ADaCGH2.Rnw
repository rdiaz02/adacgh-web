...
(SPAIN).
{\tt rueda.om@gmail.com}, {\tt rdiaz02@gmail.com}
\end{center}
...
and ploting functions.  To allow the conversion to be carried out in data
...
example, you will need to have the \texttt{CGHregions} package installed).
