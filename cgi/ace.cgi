...
if not os.path.exists(tmpDir + '/rerunACE.Rout'):
    shutil.copy("/http/adacgh/cgi/rerunACE.R", tmpDir)
    Rcommand = "cd " + tmpDir + "; " + "/usr/bin/R CMD BATCH --no-restore --no-readline --no-save -q rerunACE.R 2> errorACE.msg &"
...
## that will do the right thing.
    shutil.copy("/http/adacgh/cgi/results-pre-ace.html", tmpDir)
